...
public class productService {
    ...
    private final String _SupplierAuth;
    ...
    public productService(
                ...
                @Value("${supplier.service.username:${spring.security.user.name}}") String supplierServiceUsername,
                @Value("${supplier.service.password:${spring.security.user.password}}") String supplierServicePassword) {
        ...
        String cred = supplierServiceUsername + ":" + supplierServicePassword;
        this._SupplierAuth = "Basic " + Base64.getEncoder().encodeToString(cred.getBytes(StandardCharsets.UTF_8));
    }
